...
const styles = StyleSheet.create({
  ...
  cards: {marginTop: 16, gap: 9},
  card: {minHeight: 72, borderRadius: 16, borderWidth: 1, paddingLeft: 13, paddingRight: 11, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 9, overflow: 'hidden'},
  cardIndex: {position: 'absolute', top: 8, right: 13, fontSize: 9, lineHeight: 11, fontWeight: '800'},
  iconShell: {width: 38, height: 38, borderRadius: 19, alignItems: 'center', justifyContent: 'center', borderWidth: 1},
  cardIcon: {fontSize: 20, lineHeight: 23, fontWeight: '700'},
  cardCopy: {flex: 1, minWidth: 0},
  cardTitle: {fontSize: 13, lineHeight: 16, fontWeight: '800'},
  cardSubtitle: {marginTop: 2, fontSize: 9, lineHeight: 12},
  cardBadge: {maxWidth: 91, height: 19, borderRadius: 7, borderWidth: 1, paddingHorizontal: 5, justifyContent: 'center'},
  cardBadgeText: {fontSize: 7, lineHeight: 9, fontWeight: '700'},
  cardArrow: {width: 25, height: 25, borderRadius: 13, alignItems: 'center', justifyContent: 'center'},
  cardArrowText: {fontSize: 16, lineHeight: 18, fontWeight: '700'},
